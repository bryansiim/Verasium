    ...
    <section className="ds-section" id="ds-accessibility">
      ...
      <div className="ds-subsection">
        ...
        <div className="ds-a11y-cards">
          <div className="ds-a11y-card">
            ...
            <p>Texto primário sobre fundo, mínimo obrigatório</p>
          </div>
          <div className="ds-a11y-card">
            <div className="ds-a11y-ratio">4.5:1</div>
            <span className="ds-a11y-level">WCAG AA</span>
            <p>Texto secundário sobre fundo, mínimo aceitável</p>
          </div>
        </div>
      ...
      <div className="ds-subsection">
        ...
        <div className="ds-component-specs">
          ...
          <p>Todos os elementos interativos com <code>:focus-visible</code> visível</p>
        </div>
      </div>
      ...
      <div className="ds-subsection">
        ...
        <ul className="ds-rules-list">
          <li>Nunca usar cor como único indicador de estado, sempre acompanhar com ícone ou texto</li>
          <li>Todos os ícones decorativos com <code>aria-hidden="true"</code></li>
          <li>Inputs sempre com label associado (<code>for/id</code> ou <code>aria-label</code>)</li>
          <li>Animações respeitam <code>prefers-reduced-motion</code></li>
        </ul>
      </div>
    </section>
  );
